...
export class DatabaseTestComponent implements OnInit {
  ...
  formatColumnName(key: string): string {
    ...
    const translations: { [key: string]: string } = {
      ...
      'motivo': 'Motivo',
      'periodo': 'Período',
      'periodo (ano-mes)': 'Período (Ano-Mês)',
      'ano': 'Ano',
      'mes': 'Mês',
      'janela': 'Janela',
      ...
      'data da notificacao': 'Data da Notificação',
      'data da alteracao': 'Data da Alteração',
      'status anterior': 'Status Anterior',
      'status novo': 'Status Novo',
      'status atual': 'Status Atual',
      'tipo': 'Tipo',
      'tipo da notificacao': 'Tipo da Notificação',
      'mensagem': 'Mensagem',
      'enviado': 'Enviado',
      'quantidade avaliacoes': 'Quantidade de Avaliações',
      'media nota': 'Média de Nota',
      'total': 'Total',
      'total de agendamentos pagos': 'Total de Agendamentos Pagos',
      'total de pagamentos': 'Total de Pagamentos',
      'total de agendamentos': 'Total de Agendamentos',
      'total de prestadores': 'Total de Prestadores',
      'total de clientes': 'Total de Clientes',
      'receita total (r$)': 'Receita Total (R$)',
      'receita total paga (r$)': 'Receita Total Paga (R$)',
      'receita pendente (r$)': 'Receita Pendente (R$)',
      'receita cancelada (r$)': 'Receita Cancelada (R$)',
      'ticket medio (r$)': 'Ticket Médio (R$)',
      'primeiro pagamento': 'Primeiro Pagamento',
      'ultimo pagamento': 'Último Pagamento',
      'primeira data': 'Primeira Data',
      'ultima data': 'Última Data'
    };
